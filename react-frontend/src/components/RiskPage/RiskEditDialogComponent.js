...
mitigation: _entity?.mitigation,
probability: _entity?.probability,
impact: _entity?.impact,
        };

        setLoading(true);
        try {
            
        const result = await client.service("risk").patch(_entity._id, _data);
        props.onHide();
        props.alert({ type: "success", title: "Edit info", message: "Info risk updated successfully" });
    ...
    return (
        <Dialog header="Edit Risk" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max" footer={renderFooter()} resizable={false}>
            <div className="grid p-fluid overflow-y-auto"
            style={{ maxWidth: "55vw" }} role="risk-edit-dialog-component">
