...
import SingleRiskPage from "../components/RiskPage/SingleRiskPage";
import RiskProjectLayoutPage from "../components/RiskPage/RiskProjectLayoutPage";
import SingleIssuePage from "../components/IssuePage/SingleIssuePage";
import IssueProjectLayoutPage from "../components/IssuePage/IssueProjectLayoutPage";
...
import SingleContractorPage from "../components/ContractorPage/SingleContractorPage";
import ContractorProjectLayoutPage from "../components/ContractorPage/ContractorProjectLayoutPage";
// ~cb-add-import~
    ...
    return (
        <Routes>
            ...
            <Route element={<ProtectedRoute redirectPath={'/login'} />}>
                ...
                <Route path="/employees/:singleEmployeesId" exact element={<SingleEmployeesPage />} />
                <Route path="/employees" exact element={<EmployeeProjectLayoutPage />} />
<Route path="/risk/:singleRiskId" exact element={<SingleRiskPage />} />
<Route path="/risk" exact element={<RiskProjectLayoutPage />} />
<Route path="/issue/:singleIssueId" exact element={<SingleIssuePage />} />
<Route path="/issue" exact element={<IssueProjectLayoutPage />} />
...
<Route path="/contractor/:singleContractorId" exact element={<SingleContractorPage />} />
<Route path="/contractor" exact element={<ContractorProjectLayoutPage />} />
